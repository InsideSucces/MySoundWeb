          ...
          <div className="flex flex-row items-center px-3 md:px-9 lg:px-9 gap-8 md:gap-16 lg:gap-28 mt-12 md:mt-24">
            <Link href={"/dashboard"}>
              <button
                ...
                className="w-40 h-11 bg-gradient-to-tl from-teal-300 to-sky-500 rounded-3xl text-neutral-900 font-bold py-3 px-8 hover:opacity-90 transition duration-300 z-50"
              >
                Listen Now
              </button>
            </Link>
