          ...
          <div className="flex flex-nowrap gap-8 py-8">
            {artists.map((artist) => (
              <div className="flex-none w-48">
                <img className="w-48 h-48 rounded-full" src={artist.image} alt={artist.name} />
                <p className="mt-4 text-white text-xl font-semibold font-roboto text-center">{artist.name}</p>
              </div>
            ))}
           <div className="flex-none w-48">
