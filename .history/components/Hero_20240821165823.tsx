  ...
  return (
    <section className="relative lg:min-h-screen flex items-center overflow-hidden py-20">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center z-20 overflow-hidden">
        <div className="text-[#FEFEFE] text-[20vw]  lg:text-[570px] font-bold opacity-10 mt-20 leading-none">
          MUSIC
        </div>
        <div className="text-[#FEFEFE] text-[20vw]  lg:text-[570px] font-bold opacity-10 mt-10 leading-none">
          MYSOUND
        </div>
      </div>
