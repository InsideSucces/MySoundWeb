        ...
        <Flex direction={"column"} justify={"between"} css={{ height: "100%" }}>
          ...
          <Sidebar.Footer>
            <SidebarMenu title="GET MOBILE APP">
              ...
              >
                <div className="w-64">
                  <span className="text-[#99938f] text-sm font-semiboldm leading-tight tracking-tight">
                    Legal ⁃ Privacy ⁃ Cookie Policy ⁃ Cookie Blog Manage ⁃
                    Imprint Resource Chart
                    <br />
                  </span>
                  <span className="text-[#004cff]/75 text-sm font-semiboldm leading-tight tracking-tight">
                    Language
                  </span>
                  <span className="text-[#99938f] text-sm font-semiboldm leading-tight tracking-tight">
                    :{" "}
                  </span>
                  <span className="text-[#0a0502]/75 text-sm font-semiboldm leading-tight tracking-tight">
                    English (US)
                  </span>
                </div>
              </Text>
