  ...
  return (
    <AuthLayout>
      <section className="flex flex-col md:flex-row items-start justify-start py-20 md:px-20 lg:px-20 overflow-hidden">
        <div
          className="w-full max-w-[800px] lg:w-1/2 h-auto  px-20 py-20 bg-[#0c0c0c]/25 rounded-3xl backdrop-blur-xl flex-col justify-center items-center gap-8 inline-flex"
        >
          <div className="flex-col justify-center items-center flex">
            <div className="text-center text-[#f9f9f9] text-3xl md:text-5xl font-medium font-['Roboto']">Welcome Back</div>
          ...
          <div className="flex-col justify-start items-start gap-4 flex">
            <button
              className="w-full h-12 px-40 pt-2.5 pb-2 bg-[#f9f9f9] rounded-3xl border border-[#333333] justify-center items-center inline-flex"
            >
          ...
          <div className="w-full justify-start items-center gap-6 inline-flex">
            ...
            <div className="text-white text-xl font-normal font-['Avenir']">Or continue with email</div>
            <div className="grow shrink basis-0 h-0.5 bg-neutral-50/25" />
          </div>
